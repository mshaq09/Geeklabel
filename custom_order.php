  ...
  <table width="951" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="blackborder">
    ...
    <tr>
      <td height="32" colspan="2" align="left" valign="middle" bgcolor="#000000" class="blackborder"><blockquote>
        <p><a href="index.php" class="style18">Home</a> <span class="style17">&gt;&gt;</span> <a href="contact_us.php" class="style18">Custom Order</a></p>
      </blockquote></td>
    ...
    <tr>
      ...
      <td colspan="2" rowspan="3" align="left" valign="top" class="style4"><blockquote>
        <p class="style4"><span class="style9"><span class="style10"><br />
              <span class="style11"><span class="style14">CUSTOM ORDER FORM:</span><br />
              <br />
              </span></span></span></p>
        <form id="form1" name="form1" method="post" action="">
          <p class="style15">Order Info:</p>
          <p>
            <label>
          ...
          <label>
          Enter Order Qty for Each Item Selected
          <input type="text" name="text6" id="text6" />
          </label>
          <span class="textfieldRequiredMsg">Enter Order Qty</span><span class="textfieldInvalidFormatMsg">Enter Order Qty.</span></span><br />
          <br />
          <label>
          Select Size
          <select name="select" id="select">
            <option>XXL- Extra Large</option>
            <option>XL-Large</option>
            <option selected="selected">M-Medium</option>
            <option>S-Small</option>
          </select>
          </label>
          .</p>
          <p><span class="style15"><br />
            Billing Info:</span><br />
              <br />
          </p>
          ...
          <p>
            ...
            <span class="style13"><img src="images/mtn.jpg" alt="mtn" width="27" height="30" longdesc="mtn" />_<img src="images/zain.jpg" alt="zain" width="20" height="30" longdesc="zain" />_<img src="images/utl.jpg" alt="utl" width="34" height="30" longdesc="utl" />_<img src="images/stanbic.jpg" alt="stanbic" width="32" height="30" longdesc="stanbic" /></span></p>
          <p>
            <label>
