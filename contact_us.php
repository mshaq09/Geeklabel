...
<div align="center">
  <table width="951" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="blackborder">
    ...
    <tr>
      <td height="152" valign="top" bgcolor="#000000"><ul id="MenuBar1" class="MenuBarVertical">
      ...
      <td colspan="2" rowspan="3" valign="top" class="style4"><blockquote>
        <p class="style4"><span class="style9"><span class="style10"><br />
          ...
          <p class="style4">Physical Location	:	Plot 1466, Muyenga Tank Hill Road<br />
            Postal Address	:	P.O. Box 51236, Kampala, Uganda<br />
            Landline		:	+256 414 284 561<br />
            Mobile			: 	+256 701 468 524<br />
            Email			:	info@geeklabel.com<br />
          </p>
          <form method="post" action="contact_us_sent.php">
            <span class="style21">
            ...
            <select name="attn" size="1">
              <option value=" Geek Shop " selected="selected"> Geek Shop </option>
    ...
    <tr>
      <td height="246" align="center" valign="middle" bgcolor="#000000"><form id="form1" name="form1" method="post" action="">
